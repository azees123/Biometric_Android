...
from android.permissions import request\_permissions, Permission
...
user\_db = {}
APP\_PATH = "/sdcard/your\_app\_data"  # Customize your app's data storage path
os.makedirs(APP\_PATH, exist\_ok=True)
DB\_FILE = os.path.join(APP\_PATH, 'user\_db.pkl')
